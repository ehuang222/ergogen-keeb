function plate2_extrude_1_5_outline_fn(){
    return new CSG.Path2D([[139.475,-178.525],[139.475,-85.275]]).appendArc([141.475,-83.275],{"radius":2,"clockwise":true,"large":false}).appendPoint([160.052864,-83.275]).appendArc([160.9472912,-83.0638544],{"radius":2,"clockwise":false,"large":false}).appendPoint([179.4034045,-73.8357978]).appendArc([179.7597767,-73.6983872],{"radius":2,"clockwise":true,"large":false}).appendPoint([196.3610248,-69.061235]).appendArc([196.8990798,-68.9875],{"radius":2,"clockwise":true,"large":false}).appendPoint([272.825,-68.9875]).appendArc([274.825,-70.9875],{"radius":2,"clockwise":true,"large":false}).appendPoint([274.825,-157.0891295]).appendArc([274.6814476,-157.8331741],{"radius":2,"clockwise":true,"large":false}).appendPoint([264.4454094,-183.3728638]).appendArc([261.8491634,-184.486963],{"radius":2,"clockwise":true,"large":false}).appendPoint([217.6745019,-166.8993321]).appendArc([216.5826365,-166.7887076],{"radius":2,"clockwise":false,"large":false}).appendPoint([198.909164,-169.9491841]).appendArc([198.3668038,-170.1290981],{"radius":2,"clockwise":false,"large":false}).appendPoint([177.9972912,-180.3138544]).appendArc([177.102864,-180.525],{"radius":2,"clockwise":true,"large":false}).appendPoint([141.475,-180.525]).appendArc([139.475,-178.525],{"radius":2,"clockwise":true,"large":false}).close().innerToCAG()
.subtract(
...
.union(
    ...
    new CSG.Path2D([[427.225,-178.525],[427.225,-85.275]]).appendArc([425.225,-83.275],{"radius":2,"clockwise":false,"large":false}).appendPoint([406.647136,-83.275]).appendArc([405.7527088,-83.0638544],{"radius":2,"clockwise":true,"large":false}).appendPoint([387.2965955,-73.8357978]).appendArc([386.9402233,-73.6983872],{"radius":2,"clockwise":false,"large":false}).appendPoint([370.3389752,-69.061235]).appendArc([369.8009202,-68.9875],{"radius":2,"clockwise":false,"large":false}).appendPoint([293.875,-68.9875]).appendArc([291.875,-70.9875],{"radius":2,"clockwise":false,"large":false}).appendPoint([291.875,-157.0891295]).appendArc([292.0185524,-157.8331741],{"radius":2,"clockwise":false,"large":false}).appendPoint([302.2545906,-183.3728638]).appendArc([304.8508366,-184.486963],{"radius":2,"clockwise":false,"large":false}).appendPoint([349.0254981,-166.8993321]).appendArc([350.1173635,-166.7887076],{"radius":2,"clockwise":true,"large":false}).appendPoint([367.790836,-169.9491841]).appendArc([368.3331962,-170.1290981],{"radius":2,"clockwise":true,"large":false}).appendPoint([388.7027088,-180.3138544]).appendArc([389.597136,-180.525],{"radius":2,"clockwise":false,"large":false}).appendPoint([425.225,-180.525]).appendArc([427.225,-178.525],{"radius":2,"clockwise":false,"large":false}).close().innerToCAG()
.subtract(
...
.union(
    ...
    new CSG.Path2D([[409.7,-177],[423.7,-177]]).appendPoint([423.7,-163]).appendPoint([409.7,-163]).appendPoint([409.7,-177]).close().innerToCAG()
                ...
                function key_plate2_case_fn() {
                    

                // creating part 0 of case key_plate2
                let key_plate2__part_0 = plate2_extrude_1_5_outline_fn();

                // make sure that rotations are relative
                let key_plate2__part_0_bounds = key_plate2__part_0.getBounds();
                let key_plate2__part_0_x = key_plate2__part_0_bounds[0].x + (key_plate2__part_0_bounds[1].x - key_plate2__part_0_bounds[0].x) / 2
                let key_plate2__part_0_y = key_plate2__part_0_bounds[0].y + (key_plate2__part_0_bounds[1].y - key_plate2__part_0_bounds[0].y) / 2
                key_plate2__part_0 = translate([-key_plate2__part_0_x, -key_plate2__part_0_y, 0], key_plate2__part_0);
                key_plate2__part_0 = rotate([0,0,0], key_plate2__part_0);
                key_plate2__part_0 = translate([key_plate2__part_0_x, key_plate2__part_0_y, 0], key_plate2__part_0);

                key_plate2__part_0 = translate([0,0,0], key_plate2__part_0);
                let result = key_plate2__part_0;
